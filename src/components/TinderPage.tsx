    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-purple-50 to-white">
      ...
      <div className="flex items-center justify-between p-6">
        ...
        <div className="text-center">
          <div className="text-lg font-bold text-purple-800">Travel Tinder</div>
      ...
      {/* Cards container */}
      <div className="flex justify-center items-center flex-1 px-6 pb-32">
      ...
      {/* Action buttons */}
      <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t border-purple-100 p-6">
        <div className="flex justify-center space-x-8 max-w-sm mx-auto">
          <button
            onClick={() => handleButtonAction('left')}
            className="w-16 h-16 bg-white rounded-full shadow-lg border-2 border-red-200 flex items-center justify-center hover:border-red-300 hover:bg-red-50 transition-all duration-200 transform hover:scale-110"
          >
          ...
          <button
            ...
            className="w-16 h-16 bg-white rounded-full shadow-lg border-2 border-green-200 flex items-center justify-center hover:border-green-300 hover:bg-green-50 transition-all duration-200 transform hover:scale-110"
          >
